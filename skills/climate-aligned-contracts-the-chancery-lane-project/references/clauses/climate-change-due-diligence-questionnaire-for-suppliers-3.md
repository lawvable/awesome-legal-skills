...
2\. Has Supplier set a Net Zero Target, a Science Based Target or a Carbon Budget, signed up to [Race to Zero](https://racetozero.unfccc.int/system/race-to-zero/?_gl=1*y79oti*_ga*MjA2NDczMzIzMC4xNjk5MzY5NDIz*_ga_7ZZWT14N79*MTcwOTU2NzQxMy45LjEuMTcwOTU3MTExOC4wLjAuMA), or adopted a climate transition plan? If so, provide details of the target, budget, or plan, including the year by which Supplier plans to meet its targets.
...
22\. Are any of Supplier’s facilities certified to meet the requirements of an accredited green building program (for example, [LEED](https://www.usgbc.org/leed) or [BREEAM](https://breeam.com/))? If so, please provide details.
...
24\. Does Supplier have an [environmental management system](https://www.epa.gov/ems) (EMS) covering waste generation, energy usage, water usage and GHG emissions? If so, please provide details.
