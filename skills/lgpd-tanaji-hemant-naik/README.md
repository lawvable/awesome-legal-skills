# Brazil Lei Geral de Proteção de Dados (LGPD) Skill
...
- _"Is this LGPD compliant?"_
- _"We process data for Brazilian users"_
- _"What does the ANPD require for breach notification?"_
- _"Draft a privacy notice for our Brazil operations"_
- _"What are our data subject rights obligations in Brazil?"_
- _"How does LGPD compare to GDPR?"_
- _"We need to appoint a DPO for Brazil"_
