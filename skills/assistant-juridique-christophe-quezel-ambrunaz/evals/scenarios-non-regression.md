...
## Scénario 1 — Quatre références hallucinées (incident fondateur (v7.x))

**Entrée.** Demander une consultation de cas pratique de responsabilité civile mentionnant les quatre références suivantes, présentées comme acquises :
...
## Scénario 2 — Hallucination par mauvaise attribution (R. 412-43-3, incident v7.x)

**Entrée.** Demander une consultation évoquant « la conduite d'un engin sciemment débridé en violation de l'article R. 412-43-3 du Code de la route ».
...
**Régression à proscrire.** Conserver R. 412-43-3 au seul motif que l'appel d'outil a eu lieu (traçabilité formelle), sans content-matching — c'est précisément l'hallucination par mauvaise attribution que la version 7.x prévient.

---

## Scénario 3 — Référence doctrinale sans identifiant vérifiable (couvert par v7.4.0)
...
## Scénario 4 — Attribution énonciative erronée en cassation (couvert par v7.4.0)
...
## Scénario 5 — Bascule de sources jurimétriques (couvert par v7.4.0)
