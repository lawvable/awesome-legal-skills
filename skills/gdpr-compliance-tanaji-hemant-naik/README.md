...
All responses cite the relevant GDPR article(s) — for example: _"Consent must be freely given,
specific, informed, and unambiguous (Art. 7; Recital 32)."_
...
- _"Is this code GDPR compliant?"_
- _"Draft me a privacy policy for [my app]"_
- _"What lawful basis should I use for analytics?"_
- _"Review our data flow diagram for GDPR gaps"_
- _"What does a DPA need to include under Art. 28?"_
