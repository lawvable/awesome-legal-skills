# AI Act — EC Regulatory Framework Overview

European Commission overview of the AI regulatory framework — risk-based approach, key provisions, and implementation structure.

> **AI Omnibus 2026 — high-risk dates postponed.** This overview reproduces the European Commission's official text, which cites the *original* Art. 113 high-risk dates. The AI Omnibus 2026 postpones them: Annex III / Art. 6(2) → **2 December 2027** (from 2 Aug 2026); Annex I / Art. 6(1) → **2 August 2028** (from 2 Aug 2027); Art. 111(2) legacy cut-off → **2 December 2027**. **Not** postponed: Art. 50 transparency, the 2 August 2026 general-application date, and Art. 57 sandboxes. For operative dates see `../../../ai-act-high-risk/references/ai-omnibus-timeline-postponements.md`.
...
| NotebookLM Source ID | 96b46f73-... |

*German: KI-Verordnung — Überblick über den Regulierungsrahmen der EK*
...
All AI systems considered a clear threat to the safety, livelihoods and rights of people are banned. The AI Act prohibits eight practices:
...
- The [guidelines on prohibited AI practices under the AI Act](https://digital-strategy.ec.europa.eu/en/library/commission-publishes-guidelines-prohibited-artificial-intelligence-ai-practices-defined-ai-act), which offer legal explanations and practical examples to help stakeholders understand and comply with the prohibitions.
- The [guidelines on the AI system definition of the AI Act](https://digital-strategy.ec.europa.eu/en/library/commission-publishes-guidelines-ai-system-definition-facilitate-first-ai-acts-rules-application), to assist stakeholders in determining the scope of the AI Act.
...
Moreover, providers of generative AI have to ensure that AI-generated content is identifiable. On top of that, certain AI-generated content should be clearly and visually labelled, namely deep fakes and text published with the purpose to inform the public on matters of public interest.
...
## Conformity Process for Providers of High-Risk AI Systems
...
In July 2025, the Commission published three key instruments to support the responsible development and deployment of GPAI models:
...
The Commission is also developing other tools that offer guidance on how to comply with the AI Act's transparency rules:
...
The AI Act entered into force on 1 August 2024, and will be fully applicable two years later on 2 August 2026, with some exceptions:
...
The [Digital Package on Simplification](https://digital-strategy.ec.europa.eu/en/policies/digital-rulebook) proposes amendments to simplify the AI Act implementation and ensure the rules remain clear, simple, and innovation-friendly.
...
- Require the Commission and Member States to promote [AI literacy](https://digital-strategy.ec.europa.eu/en/policies/ai-talent-skills-and-literacy) and ensure continuous support to companies by building on existing efforts (such as the AI Office's repository of AI literacy practices, recently revamped), while keeping training obligations for high-risk deployers in place
...
All this complements actions which the Commission and its AI Office are already taking to provide clarity for businesses and national authorities, for instance, through guidelines, codes of practice, and the [AI Act Service Desk](https://ai-act-service-desk.ec.europa.eu/en).
...
- [Text of the AI Act in all EU official languages](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=OJ:L_202401689)
...
- [Questions and Answers on the AI Act](https://digital-strategy.ec.europa.eu/en/faqs/navigating-ai-act)
...
- [Upcoming guidelines on the AI Act](https://digital-strategy.ec.europa.eu/en/news/supporting-implementation-ai-act-clear-guidelines)
- [Standardisation of the AI Act](https://digital-strategy.ec.europa.eu/en/policies/ai-act-standardisation)
