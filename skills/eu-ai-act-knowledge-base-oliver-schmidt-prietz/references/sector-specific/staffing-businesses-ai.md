...
- The compliance deadline for staffing businesses is **2 December 2027** (Annex III high-risk obligations, Omnibus-postponed from 2 August 2026).
...
Starting 2 December 2027 (Annex III high-risk, Omnibus-postponed from 2 August 2026), each of these tools requires mandatory risk assessments, technical documentation, bias testing, human oversight, transparency disclosures, and continuous monitoring.
...
- **2 December 2027** *(Omnibus-postponed from 2 August 2026)***:** Full suite of high-risk system obligations becomes enforceable for Annex III systems, including all employment-related AI.

The AI Omnibus 2026 package postpones this Annex III high-risk deadline from 2 August 2026 to **2 December 2027**. As of mid-2026 the postponement is provisionally agreed (Council general approach March 2026; European Parliament adoption June 2026) and pending final adoption / OJ publication — treat 2 December 2027 as the operative planning date. See `../../../ai-act-high-risk/references/ai-omnibus-timeline-postponements.md`.
