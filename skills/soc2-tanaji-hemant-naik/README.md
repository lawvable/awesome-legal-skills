...
- _"We need to get our SOC 2 done by Q3, where do we start?"_
- _"Can you write an Incident Response Policy for us?"_
- _"What evidence do I need for CC6 access controls?"_
- _"A customer asked us to fill out their vendor security questionnaire"_
- _"We just got our AWS SOC 2 report — how do I review it?"_
- _"Draft a control statement for our change management process"_
